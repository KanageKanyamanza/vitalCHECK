const generateReminderEmailHTML = (user, message, subject) => {
  ...
  return `
    ...
    <head>
      ...
      <title>VitalCheck Enterprise Health Check</title>
    </head>
        ...
        <div style="padding: 40px 30px;">
          ...
          <div style="border-top: 1px solid #e2e8f0; padding-top: 30px; margin-top: 40px; text-align: center;">
            <p style="color: #718096; margin: 0 0 10px 0; font-size: 14px;">
              Cordialement,<br>
              <strong style="color: #fbc350;">L'équipe VitalCheck</strong>
            </p>
            <p style="color: #a0aec0; margin: 0; font-size: 12px;">
              VitalCheck Enterprise Health Check - Évaluation professionnelle d'entreprise
            </p>
          </div>
        </div>
      </div>
