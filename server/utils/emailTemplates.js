          ...
          <div style="max-width: 600px; margin: 0 auto; background-color: #ffffff; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1);">
            ...
            <div style="background: #2d3748; padding: 30px; text-align: center; color: #a0aec0;">
              <div style="margin-bottom: 20px;">
                <img src="https://www.checkmyenterprise.com/icons/ms-icon-310x310.png" alt="UBB Logo" style="width: 50px; height: 50px; border-radius: 50%; object-fit: contain; margin: 0 auto 10px auto;" />
