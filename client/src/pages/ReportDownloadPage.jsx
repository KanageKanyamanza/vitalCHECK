...
const ReportDownloadPage = () => {
  ...
  const fetchAssessment = async () => {
    try {
      setLoading(true);
      const response = await axios.get(`${getApiBaseUrl()}/assessments/${assessmentId}`);
  ...
  const handleDownload = async () => {
    try {
      setDownloading(true);
      const response = await axios.get(`${getApiBaseUrl()}/reports/download/${assessmentId}`, {
        responseType: 'blob'
      });
          ...
          <div className="p-8">
            ...
            <div className="bg-gradient-to-br from-gray-50 to-gray-100 rounded-xl p-8 mb-8">
              <div className="text-center mb-6">
                <p className="text-gray-600 mb-2">{t('reportDownload.overallScore')}</p>
              ...
              <div className="flex justify-center">
                <span className={`inline-flex items-center px-6 py-3 rounded-full text-sm font-semibold ${getStatusColor(assessment.overallStatus)}`}>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-8">
              ...
              <div className="bg-purple-50 rounded-lg p-4">
                ...
                <p className="text-lg font-semibold text-gray-900">
                  {assessment.pdfGeneratedAt ? new Date(assessment.pdfGeneratedAt).toLocaleDateString() : 'N/A'}
                </p>
              </div>
            </div>
