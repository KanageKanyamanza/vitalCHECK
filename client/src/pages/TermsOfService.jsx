			...
			<div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
				...
				<div className="bg-white rounded-xl shadow-lg p-8 space-y-8">
					...
					<section>
						...
						<div className="space-y-4">
							<p className="text-gray-700">{t("terms.paymentTerms.content")}</p>
							<ul className="list-disc list-inside text-gray-700 space-y-1">
					...
					<section>
						...
						<p className="text-gray-700">{t("terms.governingLaw.content")}</p>
					</section>
					...
					<section>
						...
						<p className="text-gray-700">{t("terms.updates.content")}</p>
					</section>
				</div>
			</div>
		</div>
