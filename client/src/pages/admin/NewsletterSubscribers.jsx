    ...
    <AdminLayout>
      <div className="p-4 lg:p-8">
        ...
        <div className="flex justify-between items-center mb-6">
          <div>
            <h1 className="text-3xl font-bold text-gray-900">Abonnés à la Newsletter</h1>
          ...
          <div className="flex gap-2">
            {selectedSubscribers.length > 0 && (
              ...
              >
                ...
                Envoyer à {selectedSubscribers.length} abonné{selectedSubscribers.length > 1 ? 's' : ''}
              </button>
            )}
            <button
              onClick={exportToCSV}
                ...
                <div className="px-6 py-4 border-t border-gray-200 bg-gray-50">
                  <div className="flex items-center justify-between">
                    <div className="text-sm text-gray-700">
                      Page {pagination.page} sur {pagination.pages} ({pagination.total} abonnés)
                    </div>
