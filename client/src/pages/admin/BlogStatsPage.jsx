  ...
  useEffect(() => {
    if (stats && chartRef1.current && chartRef2.current) {
      ...
      chartInstance1.current = new Chart(ctx1, {
        type: 'doughnut',
        data: {
          labels: stats.byType ? stats.byType.map(item => {
            const typeLabels = {
              'article': 'Articles',
      ...
      chartInstance2.current = new Chart(ctx2, {
        type: 'bar',
        data: {
          labels: stats.byCategory ? stats.byCategory.map(item => {
          ...
          datasets: [{
            ...
            data: stats.byCategory ? stats.byCategory.map(item => item.count) : [],
    ...
    <AdminLayout>
      <div className="max-w-7xl mx-auto pb-20 px-5 pt-5">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-2 md:gap-6 mb-8">
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-2 md:p-6">
            <div className="flex items-center">
              ...
              <div className="ml-4">
                <p className="text-sm font-medium text-gray-600">Total des blogs</p>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          {/* Types de blogs */}
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
            <h3 className="text-lg font-medium text-gray-900 mb-4">Détail par type</h3>
            <div className="space-y-3">
              {stats.byType && stats.byType.map((item, index) => {
                const typeLabels = {
                  'article': 'Articles',
                  'etude-cas': 'Études de cas',
                  'tutoriel': 'Tutoriels',
          ...
          {/* Catégories */}
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
            <h3 className="text-lg font-medium text-gray-900 mb-4">Détail par catégorie</h3>
            <div className="space-y-3">
              {stats.byCategory && stats.byCategory.map((item, index) => {
                const categoryLabels = {
                  'strategie': 'Stratégie',
                  'technologie': 'Technologie',
                  'finance': 'Finance',
